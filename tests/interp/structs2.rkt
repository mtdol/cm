...
(run "def sn := lam x := string x")
(check-equal? (run "struct St2 (2,7;) : sn")
"(struct St2 (2, 7;))")
(run "def sn := lam struct St2 x := string x")
(check-equal? (run "struct St2 (2,7;) : sn")
"(struct St2 (2, 7;))")
(run "def sn := lam struct St2 x, struct St2 y := string x $ \" \" $ string y")
(check-equal? (run "(struct St2 (5,6;)) : (struct St2 (2,7;)) : sn")
"(struct St2 (2, 7;)) (struct St2 (5, 6;))")
(run "def sn := lam x, struct St2 y := string x $ \" \" $ string y")
(check-equal? (run "(struct St2 (5,6;)) : (struct St2 (2,7;)) : sn")
"(struct St2 (2, 7;)) (struct St2 (5, 6;))")
(run "def sn := lam struct St2 x, y := string x $ \" \" $ string y")
(check-equal? (run "(struct St2 (5,6;)) : (struct St2 (2,7;)) : sn")
"(struct St2 (2, 7;)) (struct St2 (5, 6;))")
(run "def sn := lam x, y := string x $ \" \" $ string y")
(check-equal? (run "(struct St2 (5,6;)) : (struct St2 (2,7;)) : sn")
"(struct St2 (2, 7;)) (struct St2 (5, 6;))")

(run "def sn := lam struct St2 x, struct St1 y := string x $ \" \" $ string y")
(check-equal? (run "(struct St1 (5,(struct St2 (1,2;);))) : (struct St2 (2,7;)) : sn")
"(struct St2 (2, 7;)) (struct St1 (5, (struct St2 (1, 2;));))")
(run "def sn := lam x, struct St1 y := string x $ \" \" $ string y")
(check-equal? (run "(struct St1 (5,(struct St2 (1,2;));)) : (struct St2 (2,7;)) : sn")
"(struct St2 (2, 7;)) (struct St1 (5, (struct St2 (1, 2;));))")
(run "def sn := lam struct St2 x, y := string x $ \" \" $ string y")
(check-equal? (run "(struct St1 (5,(struct St2 (1,2;));)) : (struct St2 (2,7;)) : sn")
...
(run "typedef Stn := null")

(run "def sn := lam struct Stn x, y := string x $ \" \" $ string y")
