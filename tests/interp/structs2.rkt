...
"(struct St2 (4, 5;))")
(check-equal? (run "string def struct St2 s2 := def struct St2 s2_2 := struct St2 (4,5;)")
"(struct St2 (4, 5;))")
(check-equal? (run "string s2")
"(struct St2 (4, 5;))")
(check-equal? (run "string s2_2")
"(struct St2 (4, 5;))")
(check-equal? (run "string def struct St2 s2 := def s2_2 := struct St2 (4,5;)")
"(struct St2 (4, 5;))")
(check-equal? (run "string s2")
"(struct St2 (4, 5;))")
(check-equal? (run "string s2_2")
"(struct St2 (4, 5;))")
(check-equal? (run "string def s2 := def struct St2 s2_2 := struct St2 (4,5;)")
"(struct St2 (4, 5;))")
(check-equal? (run "string s2")
"(struct St2 (4, 5;))")
(check-equal? (run "string s2_2")
"(struct St2 (4, 5;))")
(check-equal? (run "string def struct St2 s2, struct St2 s2_2 :=
                        struct St2 (4,5;), struct St2 (3,4;)")
"((struct St2 (4, 5;)), (struct St2 (3, 4;)))")
(check-equal? (run "string s2")
"(struct St2 (4, 5;))")
(check-equal? (run "string s2_2")
