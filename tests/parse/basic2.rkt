...
(check-equal? (parse-expr (tokenize "3 % 5"))
'#s(Prim2 mod #s(Int 3) #s(Int 5)))

(check-equal? (parse-expr (tokenize "3 % 5 + 1"))
'#s(Prim2 add #s(Prim2 mod #s(Int 3) #s(Int 5)) #s(Int 1)))

(check-equal? (parse-expr (tokenize "5 / 0"))
...
(check-equal? (parse-expr (tokenize "-3"))
'#s(Prim1 neg #s(Int 3)))

(check-equal? (parse-expr (tokenize "+3"))
'#s(Prim1 pos #s(Int 3)))

(check-equal? (parse-expr (tokenize "1$3"))
'#s(Prim2 cat #s(Int 1) #s(Int 3)))

(check-equal? (parse-expr (tokenize "x$3"))
'#s(Prim2 cat #s(Var "x") #s(Int 3)))

(check-equal? (parse-expr (tokenize "3$x"))
'#s(Prim2 cat #s(Int 3) #s(Var "x")))

(check-equal? (parse-expr (tokenize "-x"))
'#s(Prim1 neg #s(Var "x")))

(check-equal? (parse-expr (tokenize "x"))
'#s(Var "x"))

(check-equal? (parse-expr (tokenize "+x / 4 + + 5"))
'#s(Prim2 add
...
(check-equal? (parse-expr (tokenize "3 and 5 +- 1"))
'#s(Prim2 and #s(Int 3) #s(Prim2 add #s(Int 5) #s(Prim1 neg #s(Int 1)))))

(check-equal? (parse-expr (tokenize "3 or 5 +- 1"))
...
(check-equal? (parse-expr (tokenize "3 xor 5 +- 1"))
'#s(Prim2 xor #s(Int 3) #s(Prim2 add #s(Int 5) #s(Prim1 neg #s(Int 1)))))

(check-equal? (parse-expr (tokenize "3 or 5 : 7"))
