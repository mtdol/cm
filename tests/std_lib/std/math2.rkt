...
(check-equal? (run "zip : {list} : {list}")
'())

(check-equal? (run "zip : {list} : {list 1}")
'())

(check-equal? (run "zip : {list 1} : {list}")
'())

(check-equal? (run "zip : {list 1} : {list 2}")
'((1 . 2)))

(check-equal? (run "zip : {list 1} : {list 2|4}")
'((1 . 2)))

(check-equal? (run "zip : {list 1|3} : {list 2|4}")
'((1 . 2) (3 . 4)))

(check-equal? (run "zip : {list 1|3} : {list 2|4|6}")
'((1 . 2) (3 . 4)))

(check-equal? (run "zip : {list 1|3|5} : {list 2|4|6}")
'((1 . 2) (3 . 4) (5 . 6)))
