...
(define op-data 
    (make-hash (list
        ...
        (cons "apply1"      (OpData 1 "prefix"  1   'Prim1   'apply1))
        ...
        (cons "eqq"         (OpData 2 "infix"   4   'Prim2   'eqq))
        (cons "not_equal"   (OpData 2 "infix"   4   'Prim2   'neq))
        (cons "neqq"        (OpData 2 "infix"   4   'Prim2   'neqq))
        (cons "plus"        (OpData 2 "infix"   5   'Prim2   'add))
        (cons "minus"       (OpData 2 "infix"   5   'Prim2   'sub))
        (cons "star"        (OpData 2 "infix"   6   'Prim2   'mult))
        (cons "slash"       (OpData 2 "infix"   6   'Prim2   'div))
        (cons "mod"         (OpData 2 "infix"   6   'Prim2   'mod))
        (cons "caret"       (OpData 2 "infix"   7   'Prim2   'exp))
        ...
        (cons "getlinesf"   (OpData 1 "prefix"  8   'Prim1   'getlinesf))
        ...
        (cons "writestrf"   (OpData 2 "prefix"  8   'Prefix2 'writestrf))
        (cons "appendstf"   (OpData 2 "prefix"  8   'Prefix2 'appendstrf))
